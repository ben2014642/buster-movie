...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('a_admin/assets/images/favicon.ico') }}">

    <!-- third party css -->
    <link href="{{ asset('a_admin/assets/css/vendor/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet"
        type="text/css" />
    <!-- third party css end -->
    <!-- App css -->
    <link href="{{ asset('a_admin/assets/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('a_admin/assets/css/app-creative.min.css') }}" rel="stylesheet" type="text/css"
        id="light-style" />
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarGenre">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="{{ route('admin.genre.index') }}">List</a>
                                </li>
                                <li>
...
<!-- third party js -->
<script src="{{ asset('a_admin/assets/js/vendor/apexcharts.min.js') }}"></script>
<script src="{{ asset('a_admin/assets/js/vendor/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ asset('a_admin/assets/js/vendor/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- third party js ends -->
