			...
			<div class="col-md-4">
				<div class="sidebar">
					...
					<div class="sb-twitter sb-it">
						...
						<div aria-live="polite" class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 2080px; transform: translate3d(-520px, 0px, 0px);" role="listbox"><div class="tweet item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide91" style="width: 520px;" data-slick-index="-1" aria-hidden="true">
							<iframe id="" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="twitter-tweet twitter-tweet-rendered" style="position: absolute; visibility: hidden; display: block; width: 0px; height: 0px; padding: 0px; border: none;"></iframe></div><div class="tweet item slick-slide slick-current slick-active" id="599202861751410688" tabindex="-1" role="option" aria-describedby="slick-slide90" style="width: 520px;" data-slick-index="0" aria-hidden="false">
							<iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="twitter-tweet twitter-tweet-rendered" style="position: absolute; visibility: hidden; display: block; width: 0px; height: 0px; padding: 0px; border: none;"></iframe></div><div class="tweet item slick-slide" id="297462728598122498" tabindex="-1" role="option" aria-describedby="slick-slide91" style="width: 520px;" data-slick-index="1" aria-hidden="true">
							<iframe id="twitter-widget-1" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="twitter-tweet twitter-tweet-rendered" style="position: absolute; visibility: hidden; display: block; width: 0px; height: 0px; padding: 0px; border: none;"></iframe></div><div class="tweet item slick-slide slick-cloned" tabindex="-1" role="option" aria-describedby="slick-slide90" style="width: 520px;" data-slick-index="2" aria-hidden="true">
							<iframe id="" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="twitter-tweet twitter-tweet-rendered" style="position: absolute; visibility: hidden; display: block; width: 0px; height: 0px; padding: 0px; border: none;"></iframe></div></div></div><ul class="slick-dots" style="" role="tablist"><li class="slick-active" aria-hidden="false" role="presentation" aria-selected="true" aria-controls="navigation90" id="slick-slide90"><button type="button" data-role="none" role="button" tabindex="0">1</button></li><li aria-hidden="true" role="presentation" aria-selected="false" aria-controls="navigation91" id="slick-slide91"><button type="button" data-role="none" role="button" tabindex="0">2</button></li></ul></div>					
					</div>
				</div>
			</div>
		</div>
