    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <table id="table-movie" class="table table-centered mb-0">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Title</th>
                            ...
                            <tbody>
                                @foreach ($movies as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->slug }}</td>
                                        <td>
                                            <img width="100px" src="{{ Storage::url($item->thumbnail) }}" alt="">
                                        </td>
                                        <td>{{ $item->description }}</td>
                                        <td>{{ $item->release_date }}</td>
                                        <td>{{ $item->revenue }}</td>
                                        <td>{{ $item->votes_avg }}</td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form class="ms-2" method="POST" action="{{ route('admin.movie.destroy', $item->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
