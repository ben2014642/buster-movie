    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <form method="POST" action="{{ route('admin.celebrity.store') }}" class=""
                    enctype="multipart/form-data">
                    @csrf
                    <div class="col-3">
                        <div class="mb-3">
                            <label for="celebrity" class="form-label">Name</label>
                            <input type="text" onkeyup="ChangeToSlug()" class="form-control" value="{{ old('name') }}"
                                id="name" name="name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ old('introduce') }}" id="introduce"
                                name="introduce">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group wrap-preview-img">
                                <img src="https://t3.ftcdn.net/jpg/04/34/72/82/360_F_434728286_OWQQvAFoXZLdGHlObozsolNeuSxhpr84.jpg"
                                    class="img-upload-preview img-fluid no-data-img" alt="">
                            </div>
                        </div>
