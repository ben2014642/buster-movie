    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <table id="table-celebrity" class="table table-centered mb-0">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                @foreach ($celebrities as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img width="50px" src="{{ Storage::url($item->image) }}" alt="">
                                        </td>
                                        <td>33</td>
                                        <td>Hiển thị</td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('admin.celebrity.edit', $item->id) }}"
                                                    class="btn btn-info rounded-pill">EDIT</a>
                                                <form class="ms-2" method="POST" action="{{ route('admin.celebrity.destroy', $item->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
...
@push('js-datatable')
    ...
    <script>
        let table = new DataTable('#table-celebrity');
    </script>
@endpush
